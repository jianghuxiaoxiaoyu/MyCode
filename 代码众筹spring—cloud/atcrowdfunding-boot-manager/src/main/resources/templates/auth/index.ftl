				...
				<ul style="padding-left:0px;" class="list-group">
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							<li style="height:30px;">
								<a href="${APP_PATH}/auth/index" style="color:red;"><i class="glyphicon glyphicon-check"></i> 实名认证审核</a> 
							</li>
							<li style="height:30px;">
					...
					<li class="list-group-item tree-closed">
						...
						<ul style="margin-top:10px;display:none;">
							...
							<li style="height:30px;">
								<a href="${APP_PATH}/process/index"><i class="glyphicon glyphicon-random"></i> 流程管理</a> 
							</li>
							<li style="height:30px;">
        ...
        <script type="text/javascript">
            ...
            function pageQuery(pageno) {
            	...
            	$.ajax({
	                ...
	                content += '  <td>';
	                content += '      <button type="button" onclick="window.location.href=\'/auth/detail?memberid='+task.memberid+'&taskid='+task.taskid+'\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
		       content += '  </td>';
	                content += '</tr>';
            				});  				       				
            				$("tbody").html(content);
